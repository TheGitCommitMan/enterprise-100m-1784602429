...
class TestStaticAdapterMiddlewareCommand(unittest.TestCase):
    """Initializes the TestStaticAdapterMiddlewareCommand with the specified configuration parameters."""
